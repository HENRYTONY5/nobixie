...
console.log('🔧 Creando tabla herramientas_entregadas...\n');
...
conexion.query(createTableQuery, (error, result) => {
    ...
    console.log('✅ Tabla herramientas_entregadas creada/verificada correctamente\n');
    
    // Insertar datos de prueba
    const insertDataQuery = `
        INSERT IGNORE INTO herramientas_entregadas (folio, empleado_id, herramienta, departamento, fecha_entrega, estado) VALUES
